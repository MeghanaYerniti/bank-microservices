...
import com.example.customer_service.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleClosedAccountException(InsufficientFundsException ex, WebRequest request) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Can't perform action, since account is CLOSED", ex.getMessage(), request);
    }
